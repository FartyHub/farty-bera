...
export function GameExplorerWip() {
  const { applications, setApplications } = useApplications();
  const application = ApplicationData[Applications.GAME_EXPLORER];
    ...
    <Window center application={application} className="w-[300px]">
      <div className="flex flex-col p-3 gap-3 text-sm">
        ...
        <div className="text-[13px]">
          <p>
            Game Explorer is not available right now. You will be able to
            explore more games with it. The devs are not sleeping to work on it.
            Stay tuned.
          </p>
        </div>
